...
//    Mat img_rgb = imread("../lokaverkefni2/myndir/check.jpg", CV_LOAD_IMAGE_COLOR);              // moved files to debug & release folder "relative path"
//    Mat img_disparity = imread("../lokaverkefni2/myndir/checkdisp2.jpg", CV_LOAD_IMAGE_GRAYSCALE);    // moved files to debug & release folder "relative path"
